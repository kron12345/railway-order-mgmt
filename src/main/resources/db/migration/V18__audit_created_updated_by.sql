...
ALTER TABLE order_positions_aud ADD COLUMN IF NOT EXISTS created_by VARCHAR(100);
ALTER TABLE order_positions_aud ADD COLUMN IF NOT EXISTS updated_by VARCHAR(100);
...
ALTER TABLE resource_needs_aud ADD COLUMN IF NOT EXISTS created_by VARCHAR(100);
ALTER TABLE resource_needs_aud ADD COLUMN IF NOT EXISTS updated_by VARCHAR(100);
...
ALTER TABLE purchase_positions_aud ADD COLUMN IF NOT EXISTS created_by VARCHAR(100);
ALTER TABLE purchase_positions_aud ADD COLUMN IF NOT EXISTS updated_by VARCHAR(100);
...
ALTER TABLE resource_catalog_items_aud ADD COLUMN IF NOT EXISTS created_by VARCHAR(100);
ALTER TABLE resource_catalog_items_aud ADD COLUMN IF NOT EXISTS updated_by VARCHAR(100);
...
ALTER TABLE timetable_archives_aud ADD COLUMN IF NOT EXISTS created_by VARCHAR(100);
ALTER TABLE timetable_archives_aud ADD COLUMN IF NOT EXISTS updated_by VARCHAR(100);
