...
| Gantt-Chart | Gantt Chart | Diagramma di Gantt | Diagramme de Gantt | Time-based bar chart visualization used in the Vehicle Planning module — vehicles on the Y-axis, hours on the X-axis, train assignments as positioned blocks |
...
| Wendezeit | Turnaround Time | Tempo di Inversione | Temps de Retournement | Minimum time needed between the arrival of one train and the departure of the next on the same vehicle — insufficient turnaround time triggers a WARNING conflict in the Vehicle Planning module |
| Mehrfachtraktion | Multiple Traction | Trazione Multipla | Traction Multiple | Operating mode where multiple vehicles (e.g. two FLIRT units) are coupled to form a longer train — modelled via CouplingPosition (FRONT/REAR) in Vehicle Planning |
