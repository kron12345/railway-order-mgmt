...
**2026-03-31** — Dokumentations-Gesamtupdate Ressourcen/Bestellungen: datenmodel.md, ARCHITECTURE.md, BEDIENUNGSANLEITUNG.md (Kap. 14), PROJECT_STATUS.md (V15-V17, neue Komponenten), GitHub Wiki (Resources-and-Purchases.md, Screenshots, Home/Sidebar Update).
